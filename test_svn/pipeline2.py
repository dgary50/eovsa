...
# changed spec processing to udb_process_1spec, jmm, 12-jan-2016
from numpy import *
from mirexec import *
import time
import fdb
...
#                    print 'UDB_PROCESS: Reset status for:'+ifb_1[j].fileid
                ...
                ufb_1a = udb_process_1spec(ufb_1, antlist)
                ...
                #Write out ufdb entry, ufb_1 is a 1 element list
                    ...
                    ufb_files_out = update_ufdb(ufb_1a, ndays=ndays)
...
def udb_process_1spec(ufb_1_in, antlist):
    '''This process inputs a single UFDB entry and spawns an IDL process to create the FITS file'''
   ...
   #string may be a list                                                                                                           
    ...
    s = "antlist = '"+uantlist+"'\n"
    f.write(s)
    s = "eovsa_write_pwrfits, fileid, hdrfile, sfreqfile, sdffile, xtsysfile, ytsysfile, outfil=outfil, project_id=project_id, antlist=antlist \n"
    f.write(s)
